		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item"><a href="car.html" class="nav-link">交友
					</a></li>
		...
		<div class="container">
			<div
				...
				<div class="col-lg-4 col-md-6 mt-0 mt-md-5 d-flex">
					<form:form method="POST" modelAttribute="memberBean" id="loginForm"
						action="./LoginServlet" class="request-form ftco-animate">

						<h2>Welcome</h2>

						<div class="form-group">

							<!-- 							<label for="" class="label">請輸入Email帳號</label> <input -->
							<!-- 								type="text" class="form-control" -->
							<!-- 								placeholder="Email"> -->
							<!-- 						</div> -->
							<!-- 						<div class="form-group"> -->
							<!-- 							<label for="" class="label">請輸入密碼</label> <input -->
							<!-- 								type="text" class="form-control" -->
						...
						<!-- 								<label for="" class="label">Pick-up date</label> <input -->
						...
						<!-- 						</div> -->
						<!-- 						<div class="form-group"> -->
						<!-- 							<label for="" class="label">Pick-up time</label> <input -->
						<!-- 								type="text" class="form-control" id="time_pick" -->
						<!-- 								placeholder="Time"> -->
						<!-- 						</div> -->

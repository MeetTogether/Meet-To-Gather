...
<body>
	...
	<section class="hero-wrap hero-wrap-2 js-fullheight"
		style="background-image: url('${pageContext.request.contextPath}/eeit10927/images/bg12.jpg');"
	...
	<section class="ftco-section ftco-degree-bg">
		<div class="row block-9 justify-content-center mb-5">
			<div class="col-md-8 mb-md-5" align="center">
				<h2 class="mb-3 bread" align="center">個人興趣</h2>
				...
				<div style="width: 60%; text-align: center;">
					<table style="width:500px; border:1px; text-align:center;">

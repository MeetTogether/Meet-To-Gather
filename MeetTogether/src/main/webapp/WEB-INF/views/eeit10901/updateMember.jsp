		...
		<div class="row block-9 justify-content-center mb-5">
			<div class="col-md-8 mb-md-5" align="center">
				...
				<div style="width: 30%; float: left;">
					<c:choose>
						<c:when test="${updateInfo.memberId == userId}">
							<a class="nav-link"
								href="${pageContext.request.contextPath}/upadateInfo/${updateInfo.memberId}">修改會員資料</a>
							<a id="bookmark1"
					...
					<table>
						<tr><td rowspan="6">
							<img style="width: 300px"
								src='${pageContext.request.contextPath}/getImage?type=member&id=${updateInfo.memberId}' /></td>
							...
							<td><form:input  path="memberEmail" value="${updateInfo.memberEmail}" readonly="true" /></td>
						<tr>
							<td style="text-align: center; width: 150px; font-weight: bolder;">密碼
						...
						<tr>
							<td style="text-align: center; width: 150px; font-weight: bolder;">縣市

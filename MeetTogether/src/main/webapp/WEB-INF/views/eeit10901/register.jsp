			...
			<div align="center">
				<form:form enctype="multipart/form-data" method="POST"
						...
						<table>
							<tr>
								...
								<td><form:input type="email" name="memberEmail"
										id="memberEmail" path="memberEmail"
							...
							<tr>
								...
								<td><form:input type="text" name="memberName"
										id="memberName" path="memberName" placeholder="請輸入暱稱"
										value="${param.mNickname}" autocomplete="off"
										class="form-control" />
					...
					<a href="${pageContext.request.contextPath}/"><input
						type="button" value="返回登入頁" id="backToLogin"></a>
					...
					<div class="ftco-footer-widget mb-4 ml-md-5">
						...
						<ul class="list-unstyled">
							<li><a href="${pageContext.request.contextPath}/"
								class="py-2 d-block">首頁</a></li>
							<li><a href="${pageContext.request.contextPath}/pairs/"
								class="py-2 d-block">交友</a></li>
							<li><a href="${pageContext.request.contextPath}/eeit10908/"
								class="py-2 d-block">活動</a></li>
							<li><a
								href="${pageContext.request.contextPath}/GetAllPostServlet"
								class="py-2 d-block">討論區</a></li>
							<li><a href="${pageContext.request.contextPath}/getmember"
								class="py-2 d-block">會員資料</a></li>
						</ul>
					</div>
				</div>
						...
						<div class="block-23 mb-3">
							<ul>
								...
								<li><a href="#"><span class="icon icon-envelope"></span><span
										class="text">109meettogether@gmail.com</span></a></li>
							</ul>
						</div>
					</div>
				</div>
